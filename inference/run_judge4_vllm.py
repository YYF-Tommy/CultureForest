...
def main(): 
    ...
    if think_mode:
        tgt_input_path = f"XXX/Judge_4/{model.split('/')[-1]}/input"
        tgt_output_path = f"XXX/Judge_4/{model.split('/')[-1]}/output"
    else:
        tgt_input_path = f"XXX/Judge_4/{model.split('/')[-1]}_nonThink/input"
        tgt_output_path = f"XXX/Judge_4/{model.split('/')[-1]}_nonThink/output"
    ...
    for folder in countryORregion_folders:
        ...
        for file in files:
            ...
            for line in data:
                ...
                complete_question = complete_question = line["Medium"]["Question_Judge4"]
                messages = [
